...
class CommonRunwayList extends Component {
  ...
  componentDidMount() {
    ...
    fetch('api/runway/report/runwayIdentCounts')
  ...
  render() {
	...
	const columns = [{
		Header: 'Runway Identification',
		accessor: 'runwayIdentification' // String-based value accessors!
	  }, {
		Header: 'Count',
		accessor: 'count'
	  }]
...
export default CommonRunwayList;